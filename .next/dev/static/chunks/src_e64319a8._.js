...
"[project]/src/lib/filters/releases.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/cards/ReleaseCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = ReleaseCard;
var _c;
__turbopack_context__.k.register(_c, "ReleaseCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/app/releases/ReleasesCatalog.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$filters$2f$releases$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/filters/releases.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cards$2f$ReleaseCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/cards/ReleaseCard.tsx [app-client] (ecmascript)");
...
function ReleasesCatalog({ releases, seriesRegistry, artists, showSeriesFilter = true }) {
    ...
    const [seriesId, setSeriesId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    ...
    const [bpmMin, setBpmMin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [bpmMax, setBpmMax] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const seriesById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[seriesById]": ()=>Object.fromEntries(seriesRegistry.map({
                "ReleasesCatalog.useMemo[seriesById]": (s)=>[
                        s.id,
                        s
                    ]
            }["ReleasesCatalog.useMemo[seriesById]"]))
    }["ReleasesCatalog.useMemo[seriesById]"], [
        seriesRegistry
    ]);
    const artistById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[artistById]": ()=>Object.fromEntries(artists.map({
                "ReleasesCatalog.useMemo[artistById]": (a)=>[
                        a.meta.id,
                        a.meta
                    ]
            }["ReleasesCatalog.useMemo[artistById]"]))
    }["ReleasesCatalog.useMemo[artistById]"], [
        artists
    ]);
    const allTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[allTypes]": ()=>Array.from(new Set(releases.map({
                "ReleasesCatalog.useMemo[allTypes]": (r)=>r.meta.type
            }["ReleasesCatalog.useMemo[allTypes]"]))).sort()
    }["ReleasesCatalog.useMemo[allTypes]"], [
        releases
    ]);
    const allArtists = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[allArtists]": ()=>artists.map({
                "ReleasesCatalog.useMemo[allArtists]": (a)=>a.meta
            }["ReleasesCatalog.useMemo[allArtists]"]).sort({
                "ReleasesCatalog.useMemo[allArtists]": (a, b)=>a.name.localeCompare(b.name)
            }["ReleasesCatalog.useMemo[allArtists]"])
    }["ReleasesCatalog.useMemo[allArtists]"], [
        artists
    ]);
    const allGenres = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[allGenres]": ()=>Array.from(new Set(releases.flatMap({
                "ReleasesCatalog.useMemo[allGenres]": (r)=>r.meta.genres
            }["ReleasesCatalog.useMemo[allGenres]"]))).sort()
    }["ReleasesCatalog.useMemo[allGenres]"], [
        releases
    ]);
    const allMoods = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[allMoods]": ()=>Array.from(new Set(releases.flatMap({
                "ReleasesCatalog.useMemo[allMoods]": (r)=>r.meta.moods
            }["ReleasesCatalog.useMemo[allMoods]"]))).sort()
    }["ReleasesCatalog.useMemo[allMoods]"], [
        releases
    ]);
    const allYears = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[allYears]": ()=>Array.from(new Set(releases.map({
                "ReleasesCatalog.useMemo[allYears]": (r)=>new Date(r.meta.release_date).getFullYear()
            }["ReleasesCatalog.useMemo[allYears]"]))).sort({
                "ReleasesCatalog.useMemo[allYears]": (a, b)=>b - a
            }["ReleasesCatalog.useMemo[allYears]"])
    }["ReleasesCatalog.useMemo[allYears]"], [
        releases
    ]);
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReleasesCatalog.useMemo[filtered]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$filters$2f$releases$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterReleases"])(releases, {
                query,
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        showSeriesFilter && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                            ...
                            children: [
                                ...
                                seriesRegistry.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: s.id,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: filtered.map(({ meta })=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cards$2f$ReleaseCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            release: meta,
                            series: series
                        }, meta.id, false, {
                            fileName: "[project]/src/app/releases/ReleasesCatalog.tsx",
...
_s(ReleasesCatalog, "6NlpjafIk4uJ/xJm/rw5KAzaagU=");
_c = ReleasesCatalog;
var _c;
__turbopack_context__.k.register(_c, "ReleasesCatalog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_e64319a8._.js.map